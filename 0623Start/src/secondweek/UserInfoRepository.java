...
public class UserInfoRepository {
	...
	public List<String> getMonthList() {
		...
		months.addAll(numberStringList("월", 1, 12));
		return months;
	}

	public List<String> numberStringList(String str, int first, int end) {
	...
	// 내림차순(연도용)
	public List<String> numberStringListReverse(String str, int first, int end) {
		List<String> list = new ArrayList<>();
		list.add(str);
		for (int i = first; i >= end; i--) {
			list.add(String.valueOf(i));
	...
	public List<String> getDayList(String selectedYear, String month) {
		List<String> days = new ArrayList<>();
		String str = "일";
		if (month.equals("1") || month.equals("3") || month.equals("5") || month.equals("7")
				|| month.equals("8") || month.equals("10") || month.equals("12")) {
			days.addAll(numberStringList(str, 1, 31));

		} else if (month.equals("2")) {
			int year = Integer.parseInt(selectedYear);
			if (year % 4 == 0 && year % 100 != 0) {
				days.addAll(numberStringList(str, 1, 29));
			} else {
				days.addAll(numberStringList(str, 1, 28));
			}
		} else if (month.equals("4") || month.equals("6") || month.equals("9")
				|| month.equals("11")) {
			days.addAll(numberStringList(str, 1, 30));
		}
		return days;
	}
	
	public List<String> getMediumAreas(String bigArea) {
	...
	public List<String> getSmallAreas(String mediumArea) {
